/**
 * ProjectsSection — Responsive card grid with jelly-card and jelly-tag.
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5">
        {projects.map((project) => (
          <div
            key={project.id}
            data-reveal
            className="jelly-card bg-card text-card-foreground rounded-xl border border-border dark:border-border/50 p-6 flex flex-col card-polished group"
          >
            {/* Category */}
